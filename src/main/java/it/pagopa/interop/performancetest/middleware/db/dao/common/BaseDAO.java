package it.pagopa.interop.performancetest.middleware.db.dao.common;
...
public abstract class BaseDAO<T> {
    ...
    protected CompletableFuture<T> updateFromEntity(T entity) {

        return this.dynamoTable.updateItem(entity).thenApply(x-> x);
    }
